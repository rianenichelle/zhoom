        ...
        <ul>
          ...
          <li class="book-a-ticket text-center dropdown"><a href="profile-seller.php">Welcome, [name]</a></li>
            <div class="dropdown-content">
              <a href="create-event.php"><i class="ion-android-calendar"></i>Create An Event</a>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10 col-lg-8">
					<div class="intro">
						<div class="profile-img"><img src="assets/img/seller-img.jpg" alt=""></div>
                        <h2><b>Some Company</b></h2>
			...
			<div class="p-item filter-movies">
				<a href="event.php" >
                    ...
                    <div class="member-info-content">
                          <h4>Frozen 2</h4>
                          <span>Ayala Center, Cebu City</span><br>
                          <div class="bookmark-icons">
                            <a href=""><i class="ion-edit"></i></a>
                            <a href=""><i class="ion-ios-trash"></i></a>
                          </div>
