        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
              <h3>Frozen 2</h3>
              <p class="font-italic">
                (short summary of movie) Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                magna aliqua.
              </p>
              <h6>SCHEDULES:</h6>
                <i>MONDAY</i>
              ...
              <div class="btns" id="random">
                <a href="pop up???" class="btn-menu animated fadeInUp scrollto">Bookmark</a>
                <a href="book-ticket.php" class="btn-menu animated fadeInUp scrollto"><i class="ion-android-bookmark"></i></a>                 
              </div>
            </div>
          </div>
